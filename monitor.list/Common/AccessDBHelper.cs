...
namespace Xp.Resin.Print.Common
{
    ...
    {
        public static string dbPath = Path.Combine(AppDomain.CurrentDomain.BaseDirectory, "Data", "ResinShopPrint.accdb");
        //数据库连接字符串(web.config来配置)，可以动态更改connectionString支持多数据库.    
        public static string connectionString = $"Provider=Microsoft.ACE.OLEDB.12.0;Data Source={dbPath};Persist Security Info=False";
        public OleDbHelper()
        {
        }
        ...
        public static void CheckDbFile()
        {
            ...
            {
                throw new Exception($"数据库文件不存在，请检查！{dbPath}");
            }
        }
        ...
        /// <param name="SQLString">查询语句</param>
        /// <returns>DataSet</returns>
        public static DataTable DataTable(string SQLString)
        {
